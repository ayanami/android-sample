...
import com.example.hoge.render.Camera3D;
import com.example.hoge.render.MyRenderer;
import com.example.hoge.render.World;
import com.example.hoge.tool.CustomMath;
import com.example.hoge.ui.AnalogStick;
...
//    }
    ...
    public void onAnalogStick(Canvas canvas, MotionEvent e, AnalogStick analogStick) {
        ...
        Camera3D cam = MainActivity.getMyRenderer().getCamera3D();
    ...
    public void onRendererTouch(MotionEvent event, MyRenderer myRenderer) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                myRenderer.getCamera3D().lookRotation((event.getX() - lastX) / -10,
                        (event.getY() - lastY) / -10);
                this.lastX = event.getX();
                this.lastY = event.getY();
                break;
