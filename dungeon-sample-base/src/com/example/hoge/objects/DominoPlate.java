package com.example.hoge.objects;
...
import com.example.hoge.render.World.Grobal;
import com.example.hoge.tool.RenderUtil;
import com.example.hoge.ui.FieldMap;
import com.webprog.R;

public final class DominoPlate extends AbstractDynamicObject{
	...
	public DominoPlate(DynamicsWorld world, Vector3f position) {
		this.fieldMapColor = FieldMap.DOMINO_COLOR;
	...
	private static void createGeometry(GL11 gl11) {
		float vertices[] = {
			...
			2.f, 0.5f, 3.0f, 0.0f, 0.0f, 0.f, 0.f, 1.f,
			-2.f, 0.5f, 3.0f, 0.0f, 1.0f, 0.f, 0.f, 1.f,
			-2.f, -0.5f, 3.0f, 1.0f, 1.0f, 0.f, 0.f, 1.f,
			2.f, -0.5f, 3.0f, 1.0f, 0.0f, 0.f, 0.f, 1.f,
			...
			2.f, 0.5f, 3.0f, 0.0f, 0.0f, 1.f, 0.f, 0.f,
			2.f, -0.5f, 3.0f, 0.0f, 1.0f, 1.f, 0.f, 0.f,
			2.f, -0.5f, -3.0f, 1.0f, 1.0f, 1.f, 0.f, 0.f,
			2.f, 0.5f, -3.0f, 1.0f, 0.0f, 1.f, 0.f, 0.f,
                
			-2.f, -0.5f, 3.0f, 0.0f, 0.0f, 0.f, -1.f, 0.f,
			-2.f, -0.5f, -3.0f, 0.0f, 1.0f, 0.f, -1.f, 0.f,
			2.f, -0.5f, -3.0f, 1.0f, 1.0f, 0.f, -1.f, 0.f,
			2.f, -0.5f, 3.0f, 1.0f, 0.0f, 0.f, -1.f, 0.f,
	...
	protected void createRigidBody(DefaultMotionState motionState) {
		...
		this.rigidBody = new RigidBody(8.f, motionState, boxShape, initVec);
	...
	public static void init(GL10 gl, Context context){
		...
		textureId = RenderUtil.loadTex(gl, context, R.drawable.domino);
	}
}